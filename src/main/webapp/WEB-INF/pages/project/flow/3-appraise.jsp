...
<div class="fillingPart">
    <label for="budget">Rozpočet:</label><sf:input path="budget" id="budget"/>
    


<sec:authorize ifAllGranted="ROLE_PROVIDER, ROLE_MANAGER">
    <input type="hidden" name="formAction" value="appraise"/>
    <input type="submit" value="Ocenit"/>
</sec:authorize>
    <sf:errors path="budget" delimiter="<br/>" cssClass="errorMessage"/>
<sec:authorize access="!hasRole('ROLE_PROVIDER') || !hasRole('ROLE_MANAGER')">
    <p>Čeká se na managera ze strany dodavatele.</p>
</sec:authorize>    
</div>
<!--/form-->
